...
public class BactrianRandomWalkBlockOperator extends KernelOperator {
    ...
    public double proposal() {
        ...
        int i_one = Randomizer.nextInt(param.getDimension());
        int i_two = Randomizer.nextInt(param.getDimension());
        int start = Math.min(i_one, i_two);
        int end = Math.max(i_one, i_two);

        double delta = kernelDistribution.getRandomDelta(start, param.getValue(start), windowSize);
